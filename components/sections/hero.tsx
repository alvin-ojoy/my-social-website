    ...
    <section className="relative py-24 sm:py-32 lg:py-40">
      <Container>
        <div className="max-w-4xl">
          ...
          <h1 className="max-w-4xl text-4xl font-semibold leading-[1.05] tracking-[-0.03em] text-neutral-900 sm:text-6xl lg:text-7xl">
            Create <em className={`${signatureFont.className} text-7xl text-[#F7C948] drop-shadow-sm`}>BETTER</em> videos.
          </h1>
